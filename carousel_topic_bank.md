...
1. Why zero-cost EMI is not always a free decision, drafted 2026-08-27, angle: "No cost EMI does not mean interest-free, the interest is moved into the price, a forgone discount, or a processing fee" (see drafts/2026-08-27_no-cost-emi-hidden-cost_carousel.md). Status: PNG carousel produced, not published.
